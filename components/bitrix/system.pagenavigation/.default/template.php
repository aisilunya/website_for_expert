			...
			<nav aria-label="Page navigation" class="text-center">
				<div class="">
					...
					if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):
						...
						<a class="modern-page-previous arrow" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"> <i class="fa fa-angle-left" aria-hidden="true"></i></a>
						<?
						else:
							if ($arResult["NavPageCount"] == ($arResult["NavPageNomer"]+1) ):
								?>
							<a class="modern-page-previous arrow" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"> <i class="fa fa-angle-left" aria-hidden="true"></i></a>
							<?
							else:
								?>
							<a class="modern-page-previous arrow" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"> <i class="fa fa-angle-left" aria-hidden="true"></i></a>
...
/*?>
		...
		?>
		<a class="modern-page-next arrow"href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
		<?
		endif; 
...
/*?>
		...
		?>
		<a class="last" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["NavPageCount"]?>"><?=$arResult["NavPageCount"]?></a>
		<?
		endif;
		?>
		<a class="modern-page-next arrow" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
